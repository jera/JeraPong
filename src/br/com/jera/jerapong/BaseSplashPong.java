 ...
 */
public abstract class BaseSplashPong extends BaseGameActivity {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public Scene onLoadScene() {
		...
		splashScene.registerUpdateHandler(new TimerHandler(splashDuration, new ITimerCallback() {
			...
			public void onTimePassed(final TimerHandler pTimerHandler) {
				BaseSplashPong.this.startActivity(new Intent(BaseSplashPong.this, BaseSplashPong.this.getFollowUpActivity()));
				BaseSplashPong.this.finish();
			}
		}));
